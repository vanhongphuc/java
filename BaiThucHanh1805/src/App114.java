...
public class App114 {
  public static void main(String[] args){
    ...
    hashMap.put("1", new Student("2021050505", "LE Phong", "C2"));
    hashMap.put("2", new Student("2021050516", "Pham Dang PHuc", "C1"));
    hashMap.put("3", new Student("2021050525", "Nguyen Nhat Phuong", "C1"));
    hashMap.put("4", new Student("2021050539", "Le Anh Quan", "C2"));
